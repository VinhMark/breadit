...
const PostVoteClient: FC<PostVoteClientProps> = ({ postId, initialVoteAmt, initialVote }) => {
  ...
  return (
    <div className='flex sm:flex-col gap-4 sm:gap-0 pr-6 sm:w-20 pb-4 sm:pb-0'>
      ...
      <Button size='sm' variant='ghost' aria-label='Up vote' onClick={() => vote(VoteType.DOWN)}>
        <ArrowBigDown
          className={cn('h-5 w-5 text-zinc-700', {
